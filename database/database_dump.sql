...
(1, 'Chocolate', 'Bakery', 25, 'lbs', 10, 'Sweet Suppliers', 8.00, '2024-11-09'),
...
-- Insert Orders (with varied dates for reporting)
...
(1, 1, '2024-11-15', '18:00:00', 2, 'Confirmed', 'Window seat preferred'),
(2, 3, '2024-11-15', '19:00:00', 4, 'Confirmed', 'Birthday celebration'),
(3, 6, '2024-11-16', '18:30:00', 4, 'Confirmed', NULL),
(4, 8, '2024-11-16', '19:30:00', 6, 'Confirmed', 'Anniversary dinner'),
(5, 10, '2024-11-17', '18:00:00', 4, 'Confirmed', NULL);
...
(1, 1, '2024-11-14', '09:00:00', '17:00:00', 30, 'Scheduled'),
(2, 1, '2024-11-14', '10:00:00', '18:00:00', 30, 'Scheduled'),
(3, 1, '2024-11-14', '11:00:00', '20:00:00', 30, 'Scheduled');
...
-- Procedure 1: Process a new order
...
-- Procedure 2: Add items to order
...
-- Procedure 3: Assign delivery to available driver
...
BEGIN
    ...
    -- Find available delivery agent at same location
...
-- Procedure 4: Complete order and process payment
...
BEGIN
    ...
    -- Free delivery agent if delivery
    IF v_agent_id IS NOT NULL THEN
        UPDATE Delivery_Agents 
...
-- Procedure 5: Update inventory stock
...
-- Function 2: Get delivery cost (driver wage for estimated time)
...
BEGIN
    ...
    DECLARE v_estimated_hours DECIMAL(10, 2) DEFAULT 0.75; -- 45 min average
...
-- Function 3: Get revenue for specific channel and date range
...
-- Function 4: Calculate customer loyalty tier
...
-- Trigger 1: Update inventory when order is completed
CREATE TRIGGER trg_UpdateInventoryOnOrder
AFTER UPDATE ON Orders
FOR EACH ROW
BEGIN
    -- This is a simplified trigger - in real scenario, would need
    -- mapping between menu items and inventory items
    IF NEW.status = 'Completed' AND OLD.status != 'Completed' THEN
        -- Log the order completion (placeholder for inventory reduction logic)
...
-- Trigger 3: Check for low stock after inventory update
...
BEGIN
    ...
    -- Ensure dine-in orders have table
...
-- View 2: Top Customers by Loyalty Points
